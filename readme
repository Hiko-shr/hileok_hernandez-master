la evaluacion para probar teoria de que si los codigos
esten funcionando una forma ordenada dependiendo si es mas comodo
o no es necesaria. 
...
agregar nombres a cada uno sin correr el riego

1.- ___.java
2.- ___repository.java
3.- ___service.java
4.- ___controller.java
5.- ___GlobalExceptionHandler

---listos

agregar codigos teoricos

es posible que salga unos codigos de map. o body, pero se investiga mas adelante
hey! una cosa, el api es importante
el get es para ver
el host es para agregar
el delete es con el nombre del api de la linea y /1 ---> se elimina justo. es mas facil
...
public class Incidencia {
    ...
    public Incidencia(String nombre, String apellido, String descripcion, String estado, int prioridad, String usuario, String fechaReporte) {
